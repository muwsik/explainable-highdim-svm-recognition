    ...
    for col, size in enumerate(
        ...
        if svm_accuracy is not None:
            ...
            if subplot_number == 1:
                ...
                xref = (
                    f"x{subplot_number} domain"
                )

                yref = (
                    f"y{subplot_number} domain"
                )
...
fig.write_image(
    ...
    r"D:\Projects\explainable-highdim-svm-recognition\charts\figure_6.svg",
